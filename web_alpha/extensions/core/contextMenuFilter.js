...
// IMPLEMENTED IN LiteGraph core
// DIFFERENCES:
// enabled for all context menu ( WIP should hide only for single element )
// Left Right navigation (left close current submenu, right open or execute current selected)
// position fix
