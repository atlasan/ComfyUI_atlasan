// shift/ctlr + rightArrow will open addNode/search context menu, when the node is added will link to current selected node
// Arrows moves selected nodes
// F focus on selected node
// Tab will select the destination node, Tab+shift will select the origin node : TODO think to nices ways to select sibiling and others
